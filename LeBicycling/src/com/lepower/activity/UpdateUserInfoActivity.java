...
public class UpdateUserInfoActivity extends BaseActivity {
	...
	@Event(value = { R.id.login_reback_btn, R.id.update_user_info_address,
			R.id.update_user_info_birthday, R.id.update_user_info_height,
			R.id.update_user_info_weight, R.id.img_userhead, R.id.tel,
			R.id.password, R.id.email,R.id.finish})
	private void click(View view) {
		...
		case R.id.finish:{
			if(check()){
				...
				HttpUtils.post(LeUrls.UPDATE_USER_INFO, params, new HttpCallback<String>(){
					@Override
