...
public class FensiAdapter extends BaseAdapter{
	...
	public FensiAdapter(Context context,List<FriendInfo> friendInfos,String userId){
		super();
		...
		holder.iv_guanzhu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (NetWorkUtil.isNetWork(context)) {
					holder.iv_guanzhu.setVisibility(View.GONE);//关注按钮隐藏
					holder.pb.setVisibility(View.VISIBLE);//进度条显示
					Log.d("heheda", "进去了");
					Log.d("heheda", "flag"+friendInfo.getFlag());
