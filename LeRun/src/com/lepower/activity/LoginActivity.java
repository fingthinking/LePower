...
public class LoginActivity extends BaseActivity {
	...
	/*	userDao = new UserDaoImpl();
		...
		String userStr = getIntent().getStringExtra("MainUser");
		...
		if(user!=null){
			...
			HttpUtils.post(LeUrls.GET_USER_INFO, params, new HttpCallback<String>(){
		...
		qqLoginListener = new LeQQListener(mTencent,new HttpCallback<String>(){
			@Override
		...
		mAuthInfo = new AuthInfo(LoginActivity.this, App.WEIBO_APPKEY, REDIRECT_URL,SCOPE);
	...
	private void initView() {
		...
		LogUtils.e(intent.getStringExtra("userName"));
		String userName = intent.getStringExtra("userName");
		LogUtils.e(et_username==null);
...
//			Intent i = getIntent();
			...
			HttpUtils.post(LeUrls.LOGIN_URL, params, new  HttpCallback<String>(){
				@Override
				public void onSuccess(String response) {
					LogUtils.e(response);
					Gson gson = new Gson();
		...
		case R.id.login_forget_password:{
			Intent intent = new Intent(LoginActivity.this,PswByTelActivity.class);
			startActivity(intent);
		}
			break;
		// 注册
		case R.id.login_register:{
			Intent intent = new Intent(LoginActivity.this, RegisterTelActivity.class);
			startActivity(intent);
//			finish();
		}
		...
		case R.id.login_pass:{
			...
			Intent intent = new Intent(LoginActivity.this, RunMainActivity.class);
			startActivity(intent);
