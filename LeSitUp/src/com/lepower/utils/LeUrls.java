...
public class LeUrls {
	/*public static final String BASE_IMAGE_URL = "http://10.6.11.135:8080/LeSports/";
	public static final String BASE_USER_URL = "http://10.6.11.82:8080/LeSports/userInfo/";
	public static final String BASE_SITUP_URL = "http://10.6.11.57:8080/LeSports/situp/";*/
	...
	public static final String BASE_SITUP_URL = "http://192.168.1.100:8080/LeSports/situp/";
	...
	public static final String GET_USER_INFO = BASE_USER_URL+"getUserInfo";  //获取用户数据
	public static final String ADD_SITUP_INFO = BASE_SITUP_URL + "addSitupInfo";
	public static final String GET_SITUP_INFO = BASE_SITUP_URL + "getSitupInfo"; 
}
