...
public class UpdateUserInfoActivity extends BaseActivity {
	...
	private void click(View view) {
		...
		case R.id.tuichu:
			...
			manager.cancel(App.pendingIntent);
	...
	private boolean check() {
		...
		aim = txtAim.getText().toString().trim();
		...
		if(TextUtils.isEmpty(aim)){
			...
			int aimNum = Integer.parseInt(aim);
			if(aimNum < 3000){
				ToastUtils.showShort("运动目标太小啦");
				return false;
			}
		}
